...
#define STRING_CONFIG_H_AUTHOR "(Allison Andrews, i3 config 04/18/2019)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 208.96
  #define DEFAULT_bedKi 20.91
  #define DEFAULT_bedKd 522.10
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 200*16/40, 200*16/40, 200*16/0.8, 720 }
